...
def add_changelog_entry(
    source_name: str, action: str, details: dict | None = None, version: str | None = None
) -> dict:
...
def get_changelog_entries(
    source_name: str | None = None, action: str | None = None, limit: int | None = None
) -> list[dict]:
...
def print_changelog(source_name: str | None = None, action: str | None = None, limit: int = 20):
...
def main():
    ...
    parser.add_argument(
        "--limit", type=int, default=20, help="Limit number of entries (default: 20)"
    )
    ...
    if args.notifications:
        ...
        print_changelog(source_name=args.source, action=args.action, limit=args.limit)
