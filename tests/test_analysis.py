...
class TestCreateBooleanColumns:
    ...
    def test_create_boolean_columns_cumulative(self):
        ...
        assert result.loc[1, "AC_10_bool"] == True  # AC_5 > 0
        assert result.loc[2, "AC_10_bool"] == True  # AC_10 > 0
    ...
    def test_create_boolean_columns_non_cumulative(self):
        ...
        assert result.loc[1, "AC_10_bool"] == False  # Only AC_5 > 0
        assert result.loc[2, "AC_10_bool"] == True   # AC_10 > 0
...
class TestCalculatePopulationMetrics:
    ...
    def test_calculate_population_metrics_grouped(self):
        ...
        trip_time_cols = ["AC_5"]
        result = calculate_population_metrics(
            data,
            trip_time_cols,
            groupby_col="TC_bool"
        )
